        ...
        {!complete && (
          <>
            ...
            <Stack direction="row" alignItems="center" sx={{ position: "relative" }}>
                  ...
                  <Textarea
                    ...
                    onKeyDown={(e) => {
                      if (e.key === "Enter" && !e.shiftKey) {
                        ...
                        if (value !== "" && chat?.appeal && chat?.["appeal.appealType"] === "onlineChat") {
                          sendMessage();
                        }
                        if (value !== "" && chat?.appeal && chat?.["appeal.appealType"] === "whatsapp") {
                          sendMessageWhatsapp();
                        }
                      }
                    }}
              ...
              {chat?.appeal && chat?.["appeal.appealType"] === "onlineChat" && !messageLoading && (
                <SendButton state={stateBtn} onClickMicrophone={onClickMicrophone} onClick={sendMessage} />
              )}
              {chat?.appeal && chat?.["appeal.appealType"] === "whatsapp" && !messageLoading && (
