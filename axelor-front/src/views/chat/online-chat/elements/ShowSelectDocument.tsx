            ...
            <Grid container flexWrap="wrap" direction="column">
                ...
                <Grid {...{ item: true }} sx={{ height: "58px", width: "100%", padding: 0 }}>
                    <Stack direction="row" spacing={2} sx={{ position: "relative", paddingRight: '10px' }} alignItems="center">
                        ...
                        {chat?.appeal && chat?.["appeal.appealType"] === "onlineChat" && <SendButton state={3} variant="fab" onClick={sendFile} />}
                        {chat?.appeal && chat?.["appeal.appealType"] === "whatsapp" && <SendButton state={3} variant="fab" onClick={sendFileWhatsapp} />}
                        {sendMessageLoading && (
                            <Stack
